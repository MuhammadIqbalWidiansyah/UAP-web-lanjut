        ...
        <main>
            <div class="pt-6 px-4">
               <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                    <h3 class="text-xl leading-none font-bold text-gray-900 mb-10 text-center">Tambah Data Karyawan</h3> <a href="<?= site_url('karyawan') ?>" >Kembali</a>
                    <br>
                        <form action="<?= site_url('karyawan/store') ?>" method="post">
                            <div class="mb-5">
                                <label
                                for="fName"
                            ...
                            <div class="mb-5">
                                ...
                                <input
                                type="text" name="jabatan" required
                                placeholder="Jabatan"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                />
                            </div>
                            <div class="mb-5">
                                ...
                                <input
                                type="text" name="gaji" required
                                placeholder="Gaji"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                />
                            </div>

                            <button type="submit" class="hidden sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3" style="background-color: #F875AA;">Simpan</button>
                        </form>
