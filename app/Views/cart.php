...
<div class="flex overflow-hidden bg-white pt-16">
            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                        <a href="<?php echo base_url('index.php/'); ?>" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                     ...
                     <li>
                        <a href="<?php echo base_url('/profile_cust'); ?>" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
      ...
      <div id="main-content" class="h-full w-full bg-white-50 relative overflow-y-auto lg:ml-64">
         <main>
                <section class="h-screen bg-white-100 text-gray-600 antialiased" x-data="app">
                    <div class="pt-6 px-4">
                        <!-- Table -->
                        <div class="container mx-2 p-10  rounded-sm border border-pink-500 bg-white shadow-lg">
                            <header class="border-b border-pink-500 px-5 py-4">
                                <div class="font-semibold text-gray-800">Keranjang Saya</div>
                            </header>

                            <div class="overflow-x-auto p-3">
                                <table class="min-w-full flex-col table-auto">
                                    <thead class="bg-pink-50 text-xs font-semibold uppercase text-gray-400">
                                        <tr>
                                            <th></th>
                                            <th class="p-2">
                                    ...
                                    <tbody class="divide-y divide-gray-100 text-sm">
                                        ...
                                        <tr>
                                            <td class="p-2">
                                                <input type="checkbox" class="h-5 w-5" value="id-1" @click="toggleCheckbox($el, 65.000)" />
                                            </td>
                                            <td class="w-28 h-28">
                                                <img class="w-full h-full" src="<?php echo base_url('images/facialwash.png'); ?>">
                                            </td>
                                            <td class="p-2">
                                                <div class="font-medium text-gray-800">Facial Wash</div>
                                            </td>
                                            <td class="p-2">
                                                <div class="text-left">1</div>
                                            </td>
                                            <td class="p-2">
                                                <div class="text-left font-medium text-green-500">Rp 65.000</div>
                                            </td>
                                            <td class="p-2">
                                        ...
                                        <tr>
                                            <td class="p-2">
                                                <input type="checkbox" class="h-5 w-5" value="id-1" @click="toggleCheckbox($el, 89.500)" />
                                            </td>
                                            <td class="w-28 h-28">
                                                <img class="w-full h-full" src="<?php echo base_url('images/daycream.png'); ?>">
                                            </td>
                                            <td class="p-2">
                                                <div class="font-medium text-gray-800">Day Cream</div>
                                            </td>
                                            <td class="p-2">
                                                <div class="text-left">1</div>
                                            </td>
                                            <td class="p-2">
                                                <div class="text-left font-medium text-green-500">Rp 89.500</div>
                                            </td>
                                            <td class="p-2">
                                                <div class="flex justify-center">
                                                    <button>
                            ...
                            <div class="flex justify-end space-x-4 border-t border-gray-100 px-5 py-4 text-2xl font-bold">
                                <div>Total</div>
                                <div class="text-blue-600">Rp <span x-text="total.toFixed(3)"></span></div>
                            </div>
