            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                     <a href="<?php echo base_url('/profile_karyawan'); ?>"class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                     ...
                     <li>
                        <a href="#" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                          ...
                          <form action="<?= url_to('logout') ?>">
                                    <?= csrf_field() ?>
                                    <span class="text-sm ml-2"><button>Log Out</button></span>
                                </form>
                        </a>
                     </li>
                     <li>
