            ...
            <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                        <a href="<?= base_url('/riwayat_transaksi') ?>" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
<body>
    ...
    <table border="1">
        <thead class="text-xs text-black-700 uppercase dark:bg-gray-700 dark:text-black-400" style="background-color: #F875AA;">
            <tr>
        ...
        <tbody>
            ...
            <?php foreach ($transaksi as $trx) : ?>
                <tr>
                    <td class="px-6 py-4"><?= $trx['nama_produk']; ?></td>
                    <td class="px-6 py-4"><?= $trx['jumlah']; ?></td>
                    <td class="px-6 py-4"><?= $trx['tanggal_transaksi']; ?></td>
                </tr>
            <?php endforeach; ?>
