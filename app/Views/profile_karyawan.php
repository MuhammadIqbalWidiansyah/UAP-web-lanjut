    ...
    <div class="h-full bg-gray-200 p-8">
        <div class="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div class="flex flex-col items-center -mt-20">
                <img src="<?php echo base_url('images/ika.jpg'); ?>" class="w-40 border-4 border-white rounded-full">
                <div class="flex items-center space-x-2 mt-2">
                    <p class="text-2xl">Ika</p>
                </div>
                ...
                <h4 class="text-xl text-gray-900 font-bold">Personal Info</h4>
                    <ul class="mt-2 text-gray-700">
                        <li class="flex border-y py-2">
                            ...
                            <span class="text-gray-700">Ika</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Tanggal Lahir:</span>
                            <span class="text-gray-700">11-02-2002</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Join:</span>
                            <span class="text-gray-700">10 Jan 2021</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">No HP:</span>
                            <span class="text-gray-700">087594831274</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Email:</span>
                            <span class="text-gray-700">Ika@gmail.com</span>
                        </li>
                    </ul>   
                </div>
            </div>
